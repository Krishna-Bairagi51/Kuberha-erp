...
// Lazy load the EditItemInventory component for code splitting
const EditItemInventorySeller = dynamic(
  () => import("@/components/features/inventory/components/edit-item/edit-inventory-seller").then((mod) => ({ default: mod.EditItemInventory })),
  {
  ...
  if (productId === null) {
    return (
      <NotFoundIdRoute
        ...
        backUrl="/seller-dashboard/inventory"
